...
- `MonetaryAmount` now converts major to minor units using ISO 4217 minor-unit exponents per currency (zero-decimal e.g. JPY/KRW, three-decimal e.g. KWD/BHD, and four-decimal CLF/UYW) instead of always multiplying by 100
